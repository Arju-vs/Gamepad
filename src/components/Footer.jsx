    ...
    <div style={{height:'300px'}} className='mt-5 container w-100'>
      <div className="d-flex justify-content-between">
        ...
        <div style={{width:'400px'}}>
          <h5><i className='text-white fa-solid fa-gamepad me-2'></i>GAME<span style={{color:'red'}}>PAD!</span> </h5>
        ...
        <div className="d-flex flex-column">
          ...
          <Link to={'/compgames'} style={{textDecoration:'none', color:'white'}}>Completed Games Page</Link>
        </div>
        {/* guides */}
        <div className="d-flex flex-column">
          <h5>Guides</h5>
      ...
      <p className="text-center mt-3">Copyright &copy; July 2024 Batch, GamePAD App. Built with React</p>
    </div>
  )
}
